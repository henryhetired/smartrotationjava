...
filepath = "/mnt/fileserver/Henry-SPIM/smart_rotation/06142018/sample1/merged/workspace_test/angularcount/"
timepoint = 2
...
savepath = "/mnt/fileserver/Henry-SPIM/smart_rotation/06142018/sample1/merged/workspace_test/"
...
#    plt.legend(handles = patches,bbox_to_anchor=(1.1,1),labelspacing = 0.01,fontsize = 5,frameon=False)
    ...
    plt.title("Imaging response curve of anglular slice " + s)
...
#plt.cla()
#plt.title("estimated vs theoretical optimal angle at tp " + str(timepoint).zfill(2))
...
#plt.plot(range(0,360,angular_resolution),c%360,'ro',label="Measured")
...
#plt.ylim((-100,600))
#plt.legend(fontsize=7)
#plt.savefig(savepath+"optimal vs imaging angle at tp "+str(timepoint).zfill(2)+".pdf",dpi = 500,format = "pdf",bbox_inches="tight")    
